...
export default function Main(): JSX.Element {
  ...
  const [showState, setShowState] = useState<showDropDownProps>({value: "", label: ""})

  const showData: showDropDownProps[] = shows.map((show): showDropDownProps =>({
  ...
  function conditionalRendering (show: showDropDownProps): JSX.Element{
    ...
    {show.value != "" && <EpisodeList navSearch={search} url={showState.value}/>}
    </>)
  }
